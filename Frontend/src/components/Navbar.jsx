  ...
  return (
    <div className="flex  items-center justify-between py-5 font-medium">
      ...
      <div className="flex items-center gap-6">
        <i className="ri-search-2-line w-5 cursor-pointer"></i>

        <div className="group relative">
          <i className="ri-user-3-line w-5 cursor-pointer"></i>
        ...
        <Link to="/cart" className="relative">
          <i className="ri-shopping-cart-line w-5 min-w-5"></i>
      ...
      <div
        className={`absolute bg-white top-0 right-0 bottom-0 transition-all ease-out duration-400 ${
          visible ? "w-full" : "w-0"
        }`}
      >
